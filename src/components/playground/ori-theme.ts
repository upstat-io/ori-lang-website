...
export const oriDarkTheme: Monaco.editor.IStandaloneThemeData = {
  ...
  colors: {
    ...
    'editorCursor.foreground': '#6cbcb8',
    // Selection - sage with alpha
    'editor.selectionBackground': '#6cbcb84d',
    'editor.inactiveSelectionBackground': '#6cbcb826',
    'editor.selectionHighlightBackground': '#6cbcb826',
    'editor.selectionHighlightBorder': '#00000000',
    'editor.wordHighlightBackground': '#6cbcb833',
    'editor.wordHighlightBorder': '#00000000',
    'editor.wordHighlightStrongBackground': '#6cbcb84d',
    'editor.wordHighlightStrongBorder': '#00000000',
    'editor.findMatchBackground': '#6cbcb866',
    'editor.findMatchHighlightBackground': '#6cbcb833',
    ...
    'editorOverviewRuler.infoForeground': '#6cbcb8',
    'editorOverviewRuler.selectionHighlightForeground': '#6cbcb84d',
    'editorOverviewRuler.findMatchForeground': '#6cbcb880',
    'editorOverviewRuler.rangeHighlightForeground': '#6cbcb84d',
    ...
    'editorOverviewRuler.wordHighlightForeground': '#6cbcb84d',
    'editorOverviewRuler.wordHighlightStrongForeground': '#6cbcb84d',
    'editorOverviewRuler.wordHighlightTextForeground': '#6cbcb84d',
    ...
    'editorBracketMatch.background': '#6cbcb826',
    'editorBracketMatch.border': '#6cbcb880',
